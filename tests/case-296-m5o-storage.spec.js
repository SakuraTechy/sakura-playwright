...
const cuecastStorageState = process.env.CUECAST_STORAGE_STATE || "../sakura-cuecast/test-lab/storage-states/m5o-storage-state.json";
...
test("CueCast case 296: M5-O export e2e smoke mock", async ({ page: initialPage }) => {
  ...
  const apiBase = process.env.CUECAST_API_BASE || "http://127.0.0.1:4207/api";
  const startUrl = process.env.CUECAST_START_URL || "http://127.0.0.1:4207/test-lab/target.html";
  const networkEvents = [];
...
// Generated from "http://127.0.0.1:4207/api" at 2026-07-06T13:46:27.031Z.
