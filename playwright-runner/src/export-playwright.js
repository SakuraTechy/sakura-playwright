...
import { normalizeCase } from './case-loader.js';
import { loadRunnerEnv, parseCliArgs, timestampForPath, trimTrailingSlash } from './utils.js';
...
async function renderSpec(testCase, config) {
  ...
  lines.push('});', '');
  lines.push(`// Generated from ${quoteJs(config.apiBase)} at ${new Date().toISOString()}.`, '');
